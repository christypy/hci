...
! function () {
    ...
    var o = function (e) {
        this._volume = 1, this._muted = !1, this.usingWebAudio = n, this.noAudio = r, this._howls = [], this._codecs = e, this.iOSAutoEnable = !0
    };
    o.prototype = {
        volume: function (e) {
            var t = this;
            ...
            load: function () {
                ...
                if (t._src = n, t._webAudio) c(t, n);
                    ...
                    l.addEventListener("error", function () {
                        l.error && 4 === l.error.code && (o.noAudio = !0), t.on("loaderror", {
                            type: l.error ? l.error.code : 0
                        })
                    }, !1), t._audioNode.push(l), l.src = n, l._pos = 0, l.preload = "auto", l.volume = f._muted ? 0 : t._volume * f.volume(), e[n] = t;
                    var h = function () {
                        t._duration = Math.ceil(10 * l.duration) / 10, 0 === Object.getOwnPropertyNames(t._sprite).length && (t._sprite = {
                            _default: [0, 1e3 * t._duration]
                        }), t._loaded || (t._loaded = !0, t.on("load")), t._autoplay && t.play(), l.removeEventListener("canplaythrough", h, !1)
                    };
                ...
                return "function" == typeof e && (n = e), e && "function" != typeof e || (e = "_default"), r._loaded ? r._sprite[e] ? (r._inactiveNode(function (i) {
                    ...
                    if (function () {
                        ...
                        var c = r._sprite[e][0] / 1e3,
                            h = r._sprite[e][1] / 1e3;
                        i.id = l, i.paused = !1, p(r, [a, c, h], l), r._playStart = t.currentTime, i.gain.value = r._volume, void 0 === i.bufferSource.start ? i.bufferSource.noteGrainOn(0, s, o) : i.bufferSource.start(0, s, o)
                    } else {
